...
from ai_functions.experimental.verified.lean.errors import LeanSetupError, LeanTimeoutError
...
def test_toolchain_defaults_and_construction_do_not_perform_setup(
    ...
    from ai_functions.experimental.verified.lean import _provision
